				...
				<div class = "boxed-section request-form">
					...
					<cfform name = "form" id = "form" action = ""><!---form to add faculties--->
						<div class = "field">
							...
							<div class = "control">
								<cfinput class = "inputField" type = "text" id = "firstName" name = "firstName" placeholder = "Enter the first name" >
							<div class = "error-msg" id = "error_firstname" name = "error_firstname"></div></div>
						</div><!---end of field--->
						<div class = "field">
							<label for = "lastName">Last Name:</label>
							<div class = "control">
								<cfinput class = "inputField" type = "text" id = "lastName" name = "lastName" placeholder = "Enter the last name" >
							<div class = "error-msg" id = "error_lastname" name = "error_lastname"></div></div>
						</div><!---end of field--->
						<div class = "field">
							<label for = "email">Email Address:</label>
							<div class = "control">
								<cfinput class = "inputField" type = "text" id = "email" name = "email" placeholder = "example@mail.com">
							<div class = "error-msg" id = "error_email" name = "error_email"></div></div>
						</div><!---end of field--->
						<div class = "field">
							<label for = "contactNumber">Contact Number:</label>
							<div class = "control">
								<cfinput class = "inputField" type = "text" id = "contactNumber" name = "contactNumber" placeholder = "Enter the contact number">
							<div class = "error-msg" id = "error_contactnumber" name = "error_contactnumber"></div></div>
						</div><!---end of field--->
						<div class = "field">
							<label for = "subject">Select the subject:</label>
							<div class = "control">
								<cfinput class = "inputField" type = "text" id = "subject" name = "subject" placeholder = "Enter the subject">

...
<cfelseif session.stLoggedInUser.roleId NEQ 2>
						...
						<div class = "boxed-section request-form">
							...
							<cfform name = "questionsForm" id = "questionsForm" action = "">
								<div class = "field">
									...
									<div class = "control"><cftextarea class = "inputField" id = "question" name = "question" placeholder = "Enter the question"></cftextarea>
									<div class = "error-msg" id = "error_question"></div></div>
								</div><!---end of field--->
								<div class = "field">
									<label for = "optionA">Option A:</label>
									<div class = "control"><cfinput class = "inputField" type = "text" id = "optiona" name = "optiona" placeholder = "Enter the first option">
									<div class = "error-msg" id = "error_optiona"></div></div>
								</div><!---end of field--->
								<div class = "field">
									<label for = "optionB">Option B:</label>
									<div class = "control"><cfinput class = "inputField" type = "text" id = "optionb" name = "optionb" placeholder = "Enter the second option">
									<div class = "error-msg" id = "error_optionb"></div></div>
								</div><!---end of field--->
								<div class = "field">
									<label for = "optionC">Option C:</label>
									<div class = "control"><cfinput class = "inputField" type = "text" id = "optionc" name = "optionc" placeholder = "Enter the third option">
									<div class = "error-msg" id = "error_optionc"></div></div>
								</div><!---end of field--->
								<div class = "field">
									<label for = "optionD">Option D:</label>
									<div class = "control"><cfinput class = "inputField" type = "text" id = "optiond" name = "optiond" placeholder = "Enter the fourth option">
	...
	<script type = "text/javascript" src = "../../includes/js/addQuestions.js"></script>

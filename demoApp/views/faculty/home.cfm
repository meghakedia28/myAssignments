				...
				<div class = "slider">
					<ul class = "slides">
						<li>
							...
							<img src = "../../freeTemplateFiles/images/kid.jpg" alt = "">
						</li>
						<li>
							<div class = "slide-caption">
...
<script src = "../../freeTemplateFiles/js/jquery-1.11.1.min.js"></script>
<script src = "../../freeTemplateFiles/js/plugins.js"></script>
<script src = "../../freeTemplateFiles/js/app.js"></script>

...
<cfset scoreIds  = createobject("component",'assign_10.components/facultyResultSet').getScoreIds(#session.stLoggedInUser.UserId#) />
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="boxed-section">
							<cfoutput>
							<cfset scoreDetails = createobject('component','assign_10/components/facultyResultSet').getScoreDetails(URL.Id) />

...
<cfset quiz  = createobject("component",'assign_10.components/viewQuizListService').fetchQuizlist(#session.stLoggedInUser.UserId#) />
		...
		<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.0/jquery-confirm.min.js"></script>
			...
			<div class="page-title">
				<div class="container">
					...
					<cfset quizDetails = createobject('component','assign_10/components/getQuizDetails').fetchQuizDetails(URL.Id, session.stLoggedInUser.userId) />
